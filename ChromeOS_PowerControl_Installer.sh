...
echo "sudo powercontrol startup             # Initiate powercontrol /etc/init .conf installer"
...
echo "sudo batterycontrol startup           # Initiate batterycontrol /etc/init .conf installer"
...
echo "sudo fancontrol startup               # Initiate fancontrol /etc/init .conf installer"
